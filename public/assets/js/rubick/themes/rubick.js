    ...
    (function () {
        ...
        (e.onChange(
            ...
            () => {
                (e.compactMenu
                    ...
                    e.compactMenuOnHover
                        ? $('.side-menu')
                              .first()
                              .addClass('side-menu--on-hover')
                        : $('.side-menu')
                              .first()
                              .removeClass('side-menu--on-hover'),
                    e.mobileMenuOpen
                        ? ($('.side-menu')
                              .first()
                          ...
                          $('.top-menu')
                              .first()
                              .addClass('top-menu--mobile-menu-open'))
                        : ($('.side-menu')
                              .first()
                    ...
                    e.compactMenu && !e.compactMenuOnHover
                        ? $('.content').first().addClass('content--compact')
                        : $('.content').first().removeClass('content--compact'),
                    e.compactMenu && e.compactMenuOnHover && !e.mobileMenuOpen
                        ? $('.content__scroll-area')
                              .first()
                              .addClass('-ml-[165px]')
                        : $('.content__scroll-area')
                              .first()
                              .removeClass('-ml-[165px]'));
            },
        ),
            ...
            $('.toggle-compact-menu').on('click', function (o) {
                (o.preventDefault(),
                    (e.compactMenu = !e.compactMenu),
                    localStorage.setItem('compactMenu', e.compactMenu));
            }),
        ...
        let r = {
            ...
            s = {
                ...
                setThemeColor(o) {
                    (localStorage.setItem('themeColor', o),
                        s.applyThemeColor());
                },
                applyThemeColor() {
        ...
        ($('.content__scroll-area').on('scroll', function () {
            ...
            (function () {
                $('.scrollable').each(function () {
                    ...
                    o.getScrollElement().scrollTop =
                        $('.side-menu__link--active')[0].getBoundingClientRect()
                            .top - 250;
                });
            })(),
            (function () {
