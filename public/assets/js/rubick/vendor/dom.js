(() => {
    var o = (dom = (() => {
        let a = (e) =>
                typeof e == 'string' && e.trim().slice(0, 1) !== '<'
                    ? document.querySelectorAll(e)
                    : typeof e == 'string' && e.trim().slice(0, 1) === '<'
                      ? [h(e)]
                      : typeof e == 'object' && e instanceof NodeList
                        ? e
                        : typeof e == 'object' && e instanceof HTMLElement
                          ? [e]
                          : typeof e == 'object' && e instanceof SVGElement
                            ? [e]
                            : e,
            h = (e) =>
            ...
            n = (e) => {
                let r = (e.composedPath && e.composedPath()) || e.path,
                    l = e.target;
                if (r != null)
                    return r.indexOf(window) < 0 ? r.concat(window) : r;
            ...
            i = (e) => {
                (c(
                    ...
                    c(e, 'css', (r, l) =>
                        l === void 0 && typeof r != 'object'
                            ? getComputedStyle(e[0])[r]
                            : (e.forEach((t) => {
                                  if (typeof r == 'object')
                    ...
                    c(e, 'is', (r) =>
                        typeof r == 'string'
                            ? (
                                  e[0].matches ||
                                  e[0].matchesSelector ||
                                  e[0].msMatchesSelector ||
                                  e[0].mozMatchesSelector ||
                                  e[0].webkitMatchesSelector ||
                                  e[0].oMatchesSelector
                              ).call(e[0], r)
                            : e[0] === r,
                    ),
                    c(e, 'attr', (r, l) => {
                    ...
                    c(e, 'width', (r) =>
                        r === void 0
                            ? e === window
                                ...
                                : typeof e[0] < 'u'
                                  ? parseInt(getComputedStyle(e[0]).width)
                                  : null
                            : (e === window
                                  ? window.resizeTo(r, window.innerHeight)
                                  : e.forEach((l) => {
                                        l.style.width = r;
                                    }),
                              i(e),
                    ...
                    c(e, 'height', (r) =>
                        r === void 0
                            ? e === window
                                ...
                                : typeof e[0] < 'u'
                                  ? parseInt(getComputedStyle(e[0]).height)
                                  : null
                            : (e === window
                                  ? window.resizeTo(window.innerWidth, r)
                                  : e.forEach((l) => {
                                        l.style.height = r;
                                    }),
                              i(e),
                    ...
                    c(e, 'last', () => {
                        let r =
                            e[e.length - 1] !== void 0 ? [e[e.length - 1]] : [];
                        return (i(r), r);
                    }),
                    c(e, 'val', (r) => {
                        if (r === void 0)
                            if (
                                e[0] instanceof HTMLSelectElement &&
                                e[0].multiple
                            ) {
                                let l = [];
                                for (let t of e[0].selectedOptions)
                                    l.push(t.value);
                                return l;
                            ...
                            e.forEach((t) => {
                                for (let u of t.children)
                                    if (r === void 0) l.push(u);
                                        ...
                                        for (let f of t.querySelectorAll(r))
                                            f === u && l.push(f);
                            }),
                            i(l),
                            l
                        ...
                        return (
                            e.forEach((l) => {
                                l.previousElementSibling !== null &&
                                    r.push(l.previousElementSibling);
                            }),
                            i(r),
                            r
                        );
